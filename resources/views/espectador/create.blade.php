        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <strong>Registro de espectadores</strong>
                </div>
                <div class="card-body">

                    <form action="{{url('espectador')}}" method="POST" class="form-horizontal" onsubmit="return Comprobar();">
                        @method('POST')
                        {{ csrf_field() }}
                        @if (count($errors)>0)
                        ...
                        <div class="form-actions">
                            ...
                            <a href="{{url('espectador')}}" class="btn btn-danger">Cancelar</a>
                        </div>
                    </form>
                </div>
            </div>
