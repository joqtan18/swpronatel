        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <strong>Reporte de Tabletas</strong>
                </div>
                <div class="card-body">
                    <form method="post" action="{{url('mostrarreporte')}}" id="elForm">
                        @method('POST')
                        {{ csrf_field() }}
                        <div class="form-group row">
                            <label class="col-md-1 col-form-label">Fecha</label>
                            <div class="col-md-3">
                                <input class="form-control" type="date" name="fecha" id="infechaini" onChange="sinDomingos();" onblur="obtenerfechafinf1();" required>
                            </div>
                        </div>
                        <div class="form-actions">
                            <input type="submit" value="Mostrar Diario" id="elSubmit" class="btn btn-primary">
