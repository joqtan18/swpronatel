        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <strong>Registro de ingenieros de TI</strong>
                </div>
                <div class="card-body">

                    <form action="{{url('ingeniero')}}" method="POST" class="form-horizontal" onsubmit="return Comprobar();">
                        @method('POST')
                        {{ csrf_field() }}
                        @if (count($errors)>0)
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-2">
                                <input class="form-control" id="trab_dni" type="text" name="trab_dni" value="{{old('trab_dni')}}" required>
                            </div>
                            <label class="col-md-1 col-form-label">Apellidos</label>
                            <div class="col-md-4">
                                <input class="form-control" id="trab_ape" type="text" name="trab_ape" value="{{old('trab_ape')}}" required>
                            </div>
                            <label class="col-md-1 col-form-label">Nombres</label>
                            <div class="col-md-3">
                                <input class="form-control" id="trab_nom" type="text" name="trab_nom" value="{{old('trab_nom')}}"required>
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-actions">
                            ...
                            <a href="{{url('ingeniero')}}" class="btn btn-danger">Cancelar</a>
                        </div>
                    </form>
                </div>
            </div>
